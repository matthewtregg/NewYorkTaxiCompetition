...
Taxi=pd.read_csv('dropofftaxi6.csv')

del(Taxi['Unnamed: 0'])


Taxi1=Taxi.loc[((Taxi['dropoff_cluster']==1465)),:]
Taxi2=Taxi.loc[~((Taxi['dropoff_cluster']==1465)),:]
Taxi1['dropoff_cluster7']=Taxi1['dropoff_cluster']
...
rep_points['dropoff_cluster']=np.arange(0,83)
...
Taxi1.to_csv('dropofftaxi7.csv')
Taxi2.to_csv('Not_dropofftaxi7.csv')
