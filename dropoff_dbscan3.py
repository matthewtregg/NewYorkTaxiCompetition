...
Taxi=pd.read_csv('dropofftaxi2.csv')

del(Taxi['Unnamed: 0'])


Taxi1=Taxi.loc[((Taxi['dropoff_cluster']==446)|(Taxi['dropoff_cluster']==448)),:]
Taxi2=Taxi.loc[~((Taxi['dropoff_cluster']==446)|(Taxi['dropoff_cluster']==448)),:]
Taxi1['dropoff_cluster3']=Taxi1['dropoff_cluster']
