...
Taxi=pd.read_csv('dropofftaxi1.csv')

del(Taxi['Unnamed: 0'])


Taxi1=Taxi.loc[((Taxi['dropoff_cluster']==1)),:]
Taxi2=Taxi.loc[~(Taxi['dropoff_cluster']==1),:]
Taxi1['dropoff_cluster2']=Taxi1['dropoff_cluster']
