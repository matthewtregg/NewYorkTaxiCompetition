...
Taxi=pd.read_csv('dropofftaxi4.csv')

del(Taxi['Unnamed: 0'])


Taxi1=Taxi.loc[((Taxi['dropoff_cluster']==1186)|(Taxi['dropoff_cluster']==1188)),:]
Taxi2=Taxi.loc[~((Taxi['dropoff_cluster']==1186)|(Taxi['dropoff_cluster']==1188)),:]
Taxi1['dropoff_cluster5']=Taxi1['dropoff_cluster']
...
rep_points['dropoff_cluster']=np.arange(0,137)
Taxi1['dropoff_cluster']=cluster_labels
Taxi1 = pd.merge(Taxi1,rep_points ,on=['dropoff_cluster'], how='left')

Taxi1['dropoff_cluster']=Taxi1['dropoff_cluster']+445+531+210+142

"""Taxi['route_index']= list(zip(Taxi['dropoff_cluster'],Taxi['pickup_cluster']))"""
Taxi1.to_csv('dropofftaxi5.csv')
Taxi2.to_csv('Not_dropofftaxi5.csv')
