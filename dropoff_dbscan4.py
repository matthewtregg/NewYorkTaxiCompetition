...
Taxi=pd.read_csv('dropofftaxi3.csv')

del(Taxi['Unnamed: 0'])


Taxi1=Taxi.loc[((Taxi['dropoff_cluster']==977)|(Taxi['dropoff_cluster']==976)),:]
Taxi2=Taxi.loc[~((Taxi['dropoff_cluster']==977)|(Taxi['dropoff_cluster']==976)),:]
Taxi1['dropoff_cluster4']=Taxi1['dropoff_cluster']
